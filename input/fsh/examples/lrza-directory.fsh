...
* insert AuthorAssignedIdentifier("https://pharmapartners.example.org/endpoints","59654248-477c-4694-b156-e0042f0765a6","http://fhir.nl/fhir/NamingSystem/kvk", "51494752")
* status = #active
...
* practitioner.identifier.system = "http://fhir.nl/fhir/NamingSystem/uzi"
* practitioner.identifier.value = "UZI-2"
* organization = Reference(Organization/lrza-o1)
...
* insert AuthorAssignedIdentifier("https://pharmapartners.example.org/devices","3f0bb8cf-9d17-4925-9c9d-6e0f8fe7b8e1","http://fhir.nl/fhir/NamingSystem/kvk", "51494752")
...
* insert AuthorAssignedIdentifier("https://nedap.example.org/endpoints","430f7379-8ec2-4e55-b096-919995da61e2","http://fhir.nl/fhir/NamingSystem/kvk", "08013836")
* status = #active
...
* insert AuthorAssignedIdentifier("https://nedap.example.org/endpoints","d4c1d657-67a9-471c-9732-9c042e9a6d43","http://fhir.nl/fhir/NamingSystem/kvk", "08013836")
* status = #active
...
* insert AuthorAssignedIdentifier("https://nedap.example.org/endpoints","2427ca0c-8a29-4a6a-aabd-50cf02f587a7","http://fhir.nl/fhir/NamingSystem/kvk", "08013836")
* status = #active
...
* practitioner.identifier.system = "http://fhir.nl/fhir/NamingSystem/uzi"
* practitioner.identifier.value = "UZI-1"
* organization = Reference(Organization/lrza-o2)
...
* insert AuthorAssignedIdentifier("https://nedap.example.org/devices","90f95f4c-3360-4f97-8c2a-77831e9e1cc7","http://fhir.nl/fhir/NamingSystem/kvk", "08013836")
...
* insert AuthorAssignedIdentifier("https://gerimedica.example.org/endpoints","8f224548-6d50-44b6-82c5-75826ee0900f","http://fhir.nl/fhir/NamingSystem/kvk", "34270859")
* status = #active
...
* insert AuthorAssignedIdentifier("https://gerimedica.example.org/endpoints","72a349cc-7336-4a91-873d-fc9349769e1a","http://fhir.nl/fhir/NamingSystem/kvk", "34270859")
* status = #active
...
* practitioner.identifier.system = "http://fhir.nl/fhir/NamingSystem/uzi"
* practitioner.identifier.value = "UZI-3"
* organization = Reference(Organization/lrza-o3)
* active = true
...
* insert AuthorAssignedIdentifier("https://gerimedica.example.org/devices","6c627191-6c6a-4b64-b2a1-049ac8fd6b4b","http://fhir.nl/fhir/NamingSystem/kvk", "34270859")
